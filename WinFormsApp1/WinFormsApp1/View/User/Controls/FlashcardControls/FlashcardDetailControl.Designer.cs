...
namespace WinFormsApp1.View.User.Controls.FlashcardControls
{
    partial class FlashcardDetailControl
    {
		...
		private void InitializeComponent()
		{
			...
			pnlActions.Size = new Size(380, 210);
			...
			btnEdit.Location = new Point(25, 95);
			btnEdit.Name = "btnEdit";
			btnEdit.Size = new Size(330, 45);
			btnEdit.TabIndex = 1;
			btnEdit.Text = "✏ Sửa";
			...
			pnlInfo.Location = new Point(1258, 310);
