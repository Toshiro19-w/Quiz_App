namespace WinFormsApp1.View.User.Controls
{
    partial class LibraryControl
    {
		...
		private void InitializeComponent()
		{
			...
			headerPanel.Size = new Size(1491, 150);
			...
			// coursesPanel
			// 
			coursesPanel.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
			...
			coursesPanel.Size = new Size(1349, 601);
